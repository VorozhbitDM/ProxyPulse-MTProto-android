...
<p align="center">
  <img alt="ProxyPulse Lite — экран списка прокси" src="docs/screenshot-lite.png" width="360">
</p>
...
- сортировка: **по рейтингу** (по умолчанию) или **по пингу**;
- кнопка **«Подключить»** открывает прокси в **Telegram**;
